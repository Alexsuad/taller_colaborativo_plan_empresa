...
|---|---:|---|---|---|---|
| DEC-001 | 2026-06-22 | Crear repo propio del Taller a partir de patrones útiles de repositorios de referencia, sin reutilizar contenido sectorial ajeno y Proyecto Automatizaciones | Evitar rehacer trabajo y reducir contaminación | Se separan preguntas, respuestas, fuentes, metodología y output | Aprobada |
