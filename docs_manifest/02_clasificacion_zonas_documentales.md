# 02 — Clasificación de zonas documentales

| Zona | Carpeta | Función |
|---|---|---|
| CONTROL | docs_control/ | Reglas, identidad, decisiones y gates |
| GUÍA | plan_empresa_guia/ | Preguntas base del plan |
| RESPUESTAS | respuestas_plan_empresa/ | Respuestas propias del Taller |
