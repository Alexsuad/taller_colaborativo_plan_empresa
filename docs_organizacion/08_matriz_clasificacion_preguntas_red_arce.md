...
| 6.2.1 | 6.2 Operaciones | ¿Qué tipo de local, condiciones mínimas y riesgos operativos deben validarse para evaluar la viabilidad del taller? | Pendiente | `[M]+[I-SIMPLE]` | `docs_organizacion/03_revision_critica_matriz_vacios.md` | Licencias básicas, requisitos técnicos, normativa general | Sí: tipo de local y tolerancia al riesgo operativo | VALIDAR_EXTERNAMENTE | MIXTO | VALIDACION_EXTERNA | BLOQUEA |
...
| 6.4.1 | 6.4 Jurídico-fiscal | ¿Qué licencias, seguros y requisitos legales generales deben verificarse antes de comprometer local, inversión o apertura? | Pendiente | `[I-SIMPLE]+[I-DEEP]` | `docs_organizacion/03_revision_critica_matriz_vacios.md` | Normativa municipal, requisitos de actividad, prevención y seguros | Sí: prioridad legal y alcance del local | VALIDAR_EXTERNAMENTE | ASESOR_EXTERNO | VALIDACION_EXTERNA | BLOQUEA |
